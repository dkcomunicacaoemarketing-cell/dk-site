...
//#region src/components/IntroDK.tsx
...
function IntroDK() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: ["D", "K"].map((letter, i) => /* @__PURE__ */ jsx("span", {
				className: "line-mask",
		...
		}), /* @__PURE__ */ jsx("span", { className: "intro-rule absolute bottom-[22%] h-px bg-foreground/25" })]
	});
}
//#endregion
//#region src/components/SectionTabs.tsx
/**
...
function SectionTabs({ sections }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("nav", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: sections.map((s, i) => /* @__PURE__ */ jsx("button", {
				onClick: () => select(i),
...
//#endregion
//#region src/components/ScrollTypewriter.tsx
/**
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("p", {
				...
				children: [/* @__PURE__ */ jsx("span", { children: text.slice(0, count) }), /* @__PURE__ */ jsx("span", {
					"aria-hidden": true,
...
function TypeOnView({ text, className = "", speed = 26, as: Tag = "p" }) {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs(Tag, {
			className,
			children: [text.slice(0, count), /* @__PURE__ */ jsx("span", {
				"aria-hidden": true,
...
var SECTIONS = [
	{
		...
		content: /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx(Label, { children: "DK Marketing Político" }),
			/* @__PURE__ */ jsx(TypeOnView, {
				as: "h2",
	...
	},
	{
		...
		content: /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx(Label, { children: "Quem está à frente" }),
			/* @__PURE__ */ jsx(TypeOnView, {
				as: "h2",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(TypeOnView, {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Label, { children: "Formação" }), /* @__PURE__ */ jsxs("ul", {
					className: "grid gap-2 text-base sm:text-lg md:grid-cols-2",
					children: [
						/* @__PURE__ */ jsx("li", { children: "Pós-graduação em Gestão e Desenvolvimento — UERGS (2021)" }),
						/* @__PURE__ */ jsx("li", { children: "Bacharel em Jornalismo — UNIFACVEST (2019)" }),
						/* @__PURE__ */ jsx("li", { children: "Bacharel em Publicidade e Propaganda — UNIFACVEST (2019)" }),
						/* @__PURE__ */ jsx("li", { children: "Tecnólogo em Fotografia — UNIFACVEST (2019)" }),
						/* @__PURE__ */ jsx("li", { children: "Técnico em Administração — SENAC (2013)" })
					]
				})]
			})
		] })
	},
	{
		...
		content: /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx(Label, { children: "Números da trajetória" }),
			/* @__PURE__ */ jsx(TypeOnView, {
				as: "h2",
	...
	},
	{
		...
		label: "Soluções",
		content: /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx(Label, { children: "Soluções" }),
			/* @__PURE__ */ jsx(TypeOnView, {
				as: "h2",
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					children: [/* @__PURE__ */ jsx("h3", {
						...
						children: group.items.map((i) => /* @__PURE__ */ jsx("li", { children: i }, i))
					})]
				}, group.t))
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Label, { children: "Diferenciais" }),
					/* @__PURE__ */ jsx(TypeOnView, {
						as: "h2",
	...
	},
	{
		...
		label: "Portfólio",
		content: /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx(Label, { children: "Portfólio" }),
			/* @__PURE__ */ jsx(TypeOnView, {
				as: "h2",
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsx("div", { className: "aspect-[4/3] rounded-2xl border border-dashed border-border bg-card" }, i))
			})
		] })
	},
	{
		...
		children: [
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("h1", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: "Role para descer" }), /* @__PURE__ */ jsx("span", { className: "h-8 w-px bg-foreground/30" })]
				})]
			}),
			/* @__PURE__ */ jsx(ScrollTypewriter, {
				text: MANIFESTO,
				heightVh: 260,
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(SectionTabs, { sections: SECTIONS })
			})
		]
	});
}
